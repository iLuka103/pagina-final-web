...
  const finalImage = isPlaceholder(img) ? "https://placehold.co/400" : img;
...
  if (isPlaceholder(finalImage)) finalImage = "https://placehold.co/600?text=Sin+Imagen";
...
      style={{
        backgroundImage: "url('https://imgs.search.brave.com/soMLAvW_2_6wOIn34l0b4vYASW1SQ8J331VRnCv78c8/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93YWxs/cGFwZXJzLmNvbS9p/bWFnZXMvaGQvbWlu/aW1hbGlzdC1jb2Zm/ZWUtMTM2Ni14LTc2/OC13YWxscGFwZXIt/bjc3bjl5czAzcXpr/bDl5ay5qcGc')"
      }}
    >
      <Navbar
        userRole={userRole}
...
        ]);
        setAppProducts(apiProds.map(normalizeProduct));
        setAppCategories(apiCats.map(normalizeCategory));
      } catch (error) {
